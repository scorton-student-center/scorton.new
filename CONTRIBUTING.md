[![Bolt Open Source Codebase](./public/social_preview_index.jpg)](https://scorton.new)

> Welcome to the **Bolt** open-source codebase! This repo contains a simple example app using the core components from scorton.new to help you get started building **AI-powered software development tools** powered by StackBlitz’s **WebContainer API**.
...
### What’s the Difference Between Bolt (This Repo) and [scorton.new](https://scorton.new)?

- **scorton.new**: This is the **commercial product** from StackBlitz—a hosted, browser-based AI development tool that enables users to prompt, run, edit, and deploy full-stack web applications directly in the browser. Built on top of the [Bolt open-source repo](https://github.com/stackblitz/scorton.new) and powered by the StackBlitz **WebContainer API**.

- **Bolt (This Repo)**: This open-source repository provides the core components used to make **scorton.new**. This repo contains the UI interface for Bolt as well as the server components, built using [Remix Run](https://remix.run/). By leveraging this repo and StackBlitz’s **WebContainer API**, you can create your own AI-powered development tools and full-stack applications that run entirely in the browser.
...
Take a look at how [Bolt uses the AI SDK](https://github.com/stackblitz/scorton.new/tree/main/app/lib/.server/llm)
...
```bash
git clone https://github.com/stackblitz/scorton.new.git
```
